...
export class Wrapper_FileDropDirective {
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean,emit1:boolean):void {
    ...
    if (emit0) { (this.subscription0 = this.context.fileOver.subscribe(_eventHandler.bind(view,'fileOver'))); }
    if (emit1) { (this.subscription1 = this.context.onFileDrop.subscribe(_eventHandler.bind(view,'onFileDrop'))); }
  }
}